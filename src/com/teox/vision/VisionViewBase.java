...
/**
 * Public abstract class for camera management. Extends android.SurfaceView.
 * It has methods that opens device's camera,
 * sets the optimal resolution depending on the height of the screen, closes the camera etc.
 */
public abstract class VisionViewBase extends SurfaceView implements SurfaceHolder.Callback, Runnable{
	private static final String TAG = "Vision::SurfaceView";
	...
	public VisionViewBase(Context context) {
		super(context);
		mHolder = getHolder();
